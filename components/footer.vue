<template>
    <div class="container">
        <div class="row d-flex justify-content-center p-5">
            ...
            <div class="col-3 linkLainnya">
                <h5>Link Lainnya</h5>
                <hr />
                <ul class="list-group">
                    <a href="https://www.kemdikbud.go.id/" target="_blank">Kemdikbud</a>
                    <a href="https://dapo.dikdasmen.kemdikbud.go.id/" target="_blank">Dapodiknasmen</a>
                    <a href="https://psmk.kemdikbud.go.id/" target="_blank">PSMK</a>
                    <a href="https://disdik.jabarprov.go.id/" target="_blank">Disdik Jabar</a>
                </ul>
            </div>
            <div class="col-2 Medsos">
                <h5>Media Sosial</h5>
                <hr />
                <div class="facebook">
                    <a href="https://www.facebook.com/4smkn" class="d-flex gap-2"><svg
                ...
                <div class="Insta">
                    <a href="https://www.instagram.com/smkn4tasikmalaya/#" class="d-flex gap-2"><svg
                            xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                ...
                <div class="twit">
                    <a href="https://x.com/4smkn " class="d-flex gap-2"><svg xmlns="http://www.w3.org/2000/svg"
